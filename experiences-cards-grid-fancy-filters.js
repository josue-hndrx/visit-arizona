...
<path d="M9 0C13.9706 0 18 4.02944 18 9C18 13.9706 13.9706 18 9 18C4.02944 18 0 13.9706 0 9C0 4.02944 4.02944 0 9 0ZM9.16699 8L6.16699 5L5 6.16699L8 9.14551L5 12.1455L6.16699 13.3125L9.16699 10.3125L12.1455 13.3125L13.3125 12.1455L10.3125 9.14551L13.3125 6.16699L12.1455 5L9.16699 8Z" fill="white" style="fill:white;fill-opacity:1;"/>
  ...
  const allRadioButtons = document.querySelectorAll(
    ".f-cards-grid-layout-1_fancy-filter-radio"
  );
  ...
  function syncCustomFilterUI() {
    ...
    // Get the list of currently active "Categories" refinements.
    const currentRefinements =
      helper.getRefinements("Categories").map((r) => r.value) || [];

    // Create a Map of facet counts for easy lookup (e.g., "outdoors" => 12).
    const facetValues = helper.lastResults.getFacetValues("Categories");
  ...
  document.addEventListener("click", function (event) {
    ...
    if (filterItem) {
      ...
      const categorySlug = filterItem.getAttribute("data-category-slug");
      const facetAttribute = "Categories"; // We are refining the 'Categories' facet
